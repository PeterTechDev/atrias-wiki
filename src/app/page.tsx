/**
 * Átrias Wiki - Epic Fantasy Landing Page
...
function getEntities() {
  try {
    const data = fs.readFileSync(path.join(process.cwd(), 'import-output/entities.json'), 'utf-8')
...
export default function Home() {
  ...
  // Featured content
  const featuredPlaces = entities.filter((e: any) => e.type === 'place').slice(0, 3)
  const recentCharacters = entities.filter((e: any) => e.type === 'character').slice(0, 3)
  const featuredFactions = entities.filter((e: any) => e.type === 'faction').slice(0, 3)
    ...
    <main className="min-h-screen bg-[#0a1628] text-slate-100">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto -mt-20">
          ...
          >
            Desvende as Crônicas de Átrias
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-3 md:grid-cols-7 gap-4">
            {[
              ...
              { icon: 'game-icons:rally-the-troops', label: 'Facções', count: stats.factions, href: '/factions' },
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-3 text-sm text-slate-600 font-crimson leading-relaxed">
                    {place.description || "Um lugar misterioso aguardando para ser descoberto nas terras de Átrias."}
                  </p>
                  <Link 
      ...
      <section className="bg-gradient-to-b from-[#1a1a2e] to-[#0a1628] py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-2 text-amber-400/60 font-crimson italic">
            Personagens que marcaram a história de Átrias
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {recentCharacters.map((char: any, i: number) => (
              <Link
                key={i}
                href={`/characters/${char.name.toLowerCase().replace(/\s+/g, '-')}`}
              ...
              >
                ...
                <p className="mt-3 text-sm text-slate-300/80 font-crimson line-clamp-2">
                  {char.description || "Um personagem misterioso do mundo de Átrias."}
                </p>
      ...
      <section className="bg-[#0a1628] py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-amber-600/60 font-crimson italic">
                As organizações que moldam o destino de Átrias
              </p>
            </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {featuredFactions.map((faction: any, i: number) => (
              <div
                key={i}
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-400 font-crimson">
                    {faction.description?.slice(0, 80) || "Uma organização influente em Átrias."}...
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="grid gap-12 md:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-slate-300 font-crimson leading-relaxed">
                O Codex de Átrias é um compêndio vivo de conhecimento, mantido por arquivistas 
                e aventureiros dedicados a preservar cada detalhe deste mundo fantástico.
              </p>
              <p className="mt-4 text-slate-400 font-crimson">
                Cada entrada é cuidadosamente extraída dos documentos originais do Mestre 
                usando inteligência artificial, garantindo precisão e fidelidade ao lore.
              </p>
            ...
            <div className="relative p-8 rounded-2xl border border-stone-800/30 bg-gradient-to-br from-slate-900/80 to-stone-900/30">
              ...
              <div className="relative space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-4xl font-cinzel text-amber-500">{total}+</p>
                </div>
      ...
      <footer className="bg-slate-950 border-t border-slate-800 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-500">
          <p className="font-crimson">© 2026 Wiki Átrias. Um cenário de campanha de D&D.</p>
