  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#e8dcc8]">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <div className="mt-4 flex justify-end gap-2"><WikiFavoriteButton entityId={entity.id} /><WikiContributionActions collection="factions" slug={slug} entityId={entity.id} enabled={process.env.WIKI_EDITING_ENABLED !== 'false'} /></div>
      </div>
